...
sub _init {
    ...
    my %questions = (
        ...
        custom_lib_path => "Do you want me to munge a custom lib path into the scripts?",
        ...
        default_city => "What city (or village, or town, or county, etc) is the site based in?",
        ...
        gmaps_api_key => "Do you have a Google Maps API key to use with this guide?",
        centre_long => "What is the longitude of the centre point of a map to draw for your guide?  You may paste in a Google Maps URL here (hint: copy URL from 'Link to this page')",
        centre_lat => "What is the latitude of the centre point of a map to draw for your guide?",
        default_gmaps_zoom => "What default zoom level shall we use for Google Maps?",
        default_gmaps_search_zoom => "What default zoom level shall we use for Google Maps in the search results?",
        show_gmap_in_node_display => "Would you like to display a Google Map on every node that has geodata?",
        force_wgs84 => "Forcibly treat stored lat/long data as if they used the WGS84 ellipsoid?",
        google_analytics_key => "Do you have a Google Analytics key to use with this guide?",
        ...
        spam_detector_module => "Do you have a module to use for spam detection?",
        host_checker_module => "Do you have a module for running an IP blacklist?",
